import React, { useState } from "react";
 ...
 const PvlApp = () => {
   ...
   const [members, setMembers] = useState([
     { id: "230001", fullname: "Nguyễn Văn Kiên", username: "Test1", password: "123456" },
     { id: "230002", fullname: "Trần Thanh Hòa", username: "C", password: "abcdef" },
     { id: "230003", fullname: "Lê Quang Quân", username: "B", password: "qwerty" },
   ]);
 //thêm mới
